...
{
    public class KullaniciSayfaYetkiVM : PagingVMBase
    {
        [Display(Name = "Id")]
    ...
    public class KullaniciSayfaYetkiEkleVM : VMBase
    {
    ...
    public class KullaniciSayfaYetkiDuzenleVM : VMBase
    {
        [Display(Name = "Id")]
        public int Id { get; set; }
    ...
    public class KullaniciSayfaYetkiData
    {
