    ...
    public class TahakkukServiceClient
    {
        ...
        public TahakkukEkleSonucVm TahakkukOlustur(TahakkukEkleVm tahakkukBilgi)
        {
            ...
            try
            {
                ...
                var sonuc = _client.tahakkukOlusturKdvli(kullanici, tahakkukBilgi.SicilNo, tahakkukBilgi.GelirId,
                                   tahakkukBilgi.KdvGelirId, tahakkukBilgi.Yil, tahakkukBilgi.TaksitNo, tahakkukBilgi.SonOdemeTarihi.ToString(),
